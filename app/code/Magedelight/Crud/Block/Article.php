<?php 
namespace Magedelight\Crud\Block;

use \Magento\Framework\View\Element\Template;
use \Magento\Framework\View\Element\Template\Context;
use \Magedelight\Crud\Model\ResourceModel\View\CollectionFactory as ViewCollectionFactory;
...
class Article extends Template{
    ...
    */
    public function getCollection()
    {
     ...
     /**
     * For a given article, returns its url
     * @param int $viewId
     * @return string
     */

     public function getArticleUrl($viewId){
        return $this->getUrl('crud/index/view/'.$viewId,['_secure'=>true]);
     }
}